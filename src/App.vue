    ...
    onLog(respuesta) {
      ...
      if(respuesta.resultado){
        ...
        respuesta.datos.rolUsuario )
          ...
          if(respuesta.datos.rolUsuario == "ADMINISTRADOR") this.$router.push( { name: "InicioComponent"} );
          if(respuesta.datos.rolUsuario == "RECEPCIONISTA") this.$router.push( { name: "Recepcion"} );
